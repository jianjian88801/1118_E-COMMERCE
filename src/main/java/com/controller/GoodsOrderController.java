...
//                            goodsOrderEntity.setGoodsOrderCourierNumber(data.get(0));                    //快递单号 要改的
//                            goodsOrderEntity.setGoodsOrderCourierName(data.get(0));                    //快递公司 要改的
...
//                            goodsOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody GoodsOrderEntity goodsOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,goodsOrder:{}",this.getClass().getName(),goodsOrder.toString());
            ...
            goodsOrder.setGoodsOrderTruePrice(0.0); //设置实付价格
    ...
    */
    ...
    public R deliver(Integer id ,String goodsOrderCourierNumber, String goodsOrderCourierName){
        logger.debug("refund:,,Controller:{},,ids:{}",this.getClass().getName(),id.toString());
        GoodsOrderEntity  goodsOrderEntity = new  GoodsOrderEntity();;
        goodsOrderEntity.setId(id);
        goodsOrderEntity.setGoodsOrderTypes(4);
        goodsOrderEntity.setGoodsOrderCourierNumber(goodsOrderCourierNumber);
        goodsOrderEntity.setGoodsOrderCourierName(goodsOrderCourierName);
