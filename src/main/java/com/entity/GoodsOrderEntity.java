...
public class GoodsOrderEntity<T> implements Serializable {
     ...
     * 快递单号
     */
    @TableField(value = "goods_order_courier_number")

    private String goodsOrderCourierNumber;


    /**
     * 快递公司
     */
    @TableField(value = "goods_order_courier_name")

    private String goodsOrderCourierName;
	 ...
	 * 设置：快递单号
	 */
    public String getGoodsOrderCourierNumber() {
        return goodsOrderCourierNumber;
    }
    ...
    public void setGoodsOrderCourierNumber(String goodsOrderCourierNumber) {
        this.goodsOrderCourierNumber = goodsOrderCourierNumber;
    }
    /**
	 * 设置：快递公司
	 */
    public String getGoodsOrderCourierName() {
        return goodsOrderCourierName;
    }
    ...
    public void setGoodsOrderCourierName(String goodsOrderCourierName) {
        this.goodsOrderCourierName = goodsOrderCourierName;
    }
    /**
	 * 设置：实付价格
	 */
    ...
    public String toString() {
        return "GoodsOrder{" +
            ...
            ", yonghuId=" + yonghuId +
            ", buyNumber=" + buyNumber +
            ", goodsOrderCourierNumber=" + goodsOrderCourierNumber +
            ", goodsOrderCourierName=" + goodsOrderCourierName +
